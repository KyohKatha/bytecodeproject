    ...
    <body>
        ...
        <div style="margin-top:-44px; position: relative;">
            <ul id="menu">
                ...
                <%if (usuarioLogado != null) {%>
                <li><a href="ManutencaoUsuarios?tipo=3" target="_self" title="Minhas Inscrições" class="current">Minhas Inscrições</a></li>
                ...
                <div class = "minhasInscricoes">
                    ...
                    <%
                                    ...
                                    if (eventos == null || eventos.isEmpty()) {
                                        out.println("Você não está inscrito em nenhum evento</p>");
                                    } else {
                                        %>
                                        Eventos em que você está inscrito:</p>
